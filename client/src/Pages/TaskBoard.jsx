...
export const TaskBoard = () => {
  ...
  return (
    <div className={`${themeMode ? 'light' : 'dark'} flex-1 p-6`}>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className={`${themeMode ? 'light' : 'dark'} p-6 rounded-lg shadow-lg w-96`}>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          {['todo', 'in-progress', 'done'].map((status) => (
            <div
              key={status}
              className={`${themeMode ? 'bg-gray-100' : 'bg-gray-800'} p-4 rounded shadow`}
            >
